...
window.addEventListener("DOMContentLoaded", function () {
    ...
    document.body.addEventListener("click", function (e) {
        ...
        if (target) {
            stopBGM();
            const videoSrc = target.getAttribute("data-src") || "../mp4/02_08_exp.mp4";
    ...
    const quizSet = [
        {
            ...
            questions: [
                {
                    type: "multi",
                    q: "고객(정보주체)이 자신의 개인정보가 어떤 경로로 수집되었는지 출처를 알려달라고 요청한 경우, 기업은 어떻게 해야 하나요? (8점)",
                    a: 1,
                    options: ["고객에게 수집한 출처를 알려줘야 한다.", "출처를 굳이 알려줄 의무는 없다."],
                    explanation: "<button class='video_exp' data-src='https://vod.cdn.hunet.co.kr/eLearning/Hunet/HLAC12148/02_08_exp.mp4'><img src='../common/img/quizUI/exp_button.png' alt='해설보기'></button>",
                    point: 8
                },
            ]
        },
