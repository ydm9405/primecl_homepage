...
window.addEventListener("DOMContentLoaded", function () {
    ...
    document.body.addEventListener("click", function (e) {
        ...
        if (target) {
            stopBGM();
            const videoSrc = target.getAttribute("data-src") || "../mp4/02_10_exp.mp4";
    ...
    const quizSet = [
        {
            ...
            questions: [
                {
                    type: "multi",
                    q: "고객으로부터 광고성 정보 전송에 대한 사전 동의 및 철회에 대한 요청을 받았을 경우, 며칠 이내에 처리된 결과를 통지해야 하나요? (8점)",
                    a: 2,
                    options: ["30일 이내 처리", "14일 이내 처리"],
                    explanation: "<button class='video_exp' data-src='https://vod.cdn.hunet.co.kr/eLearning/Hunet/HLAC12148/02_10_exp.mp4'><img src='../common/img/quizUI/exp_button.png' alt='해설보기'></button>",
                    point: 8
                },
            ]
        },
    ...
    function showSetResult() {
        ...
        if (typeof top.saveChapterScore === "function") {
            try {
                top.saveChapterScore(chapterType, scoreByChapter[chapterType], 10);
        ...
        if (currentQuestion.type === "ox") {
            ...
            buttons.forEach((btn, idx) => {
                ...
                if (optIndex === correct) {
                    ...
                    // 정답 말풍선 아이콘 추가
                    btn.innerHTML = `<img src="../common/img/quizUI/correctIcon_multi_right.png" class="correctIcon_multi"> ${btn.innerHTML}`;
                }
